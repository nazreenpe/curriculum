...
function exercise4(varA, varB) {
  var equality, answer4;
  if (varA === varB) {
      equality = "equal";
  } else {
    equality = "differ";
  }
  answer4 = `${varA} and ${varB} are ${equality}.`;   
  return answer4;
}
...
/* case 1: varA = 4, varB = "4"
   case 2 : varA = null, varB = NaN
*/
